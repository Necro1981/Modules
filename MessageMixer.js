...
let countCharacter =
function(inputString, inputCharacter) {
  let count = 0;
...
let capitalizeFirstCharacterOfWords =
function(string) {
...
let replaceFirstOccurence =
function(string, toBeReplaced, replaceWith) {
  return string.replace(toBeReplaced, replaceWith);
};

let replaceAllOccurrences =
function(string, toBeReplaced, replaceWith) {
